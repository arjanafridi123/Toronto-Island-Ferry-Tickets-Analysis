...
st.title("🚢 Toronto Island Ferry Ticket Analytics Dashboard")

st.markdown("""
### Dashboard Overview

This dashboard monitors Toronto Island Ferry ticket sales,
redemptions, passenger movement, seasonal demand,
